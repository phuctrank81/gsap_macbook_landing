...
const performanceImages = [
    { id: "p1", src: "apple-macbook_public/public/performance1.png" },
    { id: "p2", src: "apple-macbook_public/public/performance2.png" },
    { id: "p3", src: "apple-macbook_public/public/performance3.png" },
    { id: "p4", src: "apple-macbook_public/public/performance4.png" },
    { id: "p5", src: "apple-macbook_public/public/performance5.jpg" },
    { id: "p6", src: "apple-macbook_public/public/performance6.png" },
    { id: "p7", src: "apple-macbook_public/public/performance7.png" },
];
...
const features = [
    {
        id: 1,
        icon: "apple-macbook_public/public/feature-icon1.svg",
        highlight: "Email AI.",
    ...
    {
        id: 2,
        icon: "apple-macbook_public/public/feature-icon2.svg",
        highlight: "Image AI.",
    ...
    {
        id: 3,
        icon: "apple-macbook_public/public/feature-icon3.svg",
    ...
    {
        id: 4,
        icon: "apple-macbook_public/public/feature-icon4.svg",
        highlight: "AirDrop.",
    ...
    {
        id: 5,
        icon: "apple-macbook_public/public/feature-icon5.svg",
